...
(module+ main
  ...
  (geo-hb-append #:gapsize 32.0
                 (plot-cartesian #:y-down? #f #:x-range (cons -5 +5) #:y-range (cons -1 16) #:unit-length (&% 10))
                 (plot-cartesian #:y-down? #t #:x-range (cons -5 +5) #:y-range (cons -1 16) #:unit-length (&% 10))))
