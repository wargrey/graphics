...
(define geo-parallelogram
  (lambda [#:id [id : (Option Symbol) #false]
    ...
    (geo-polygon #:id (or id (gensym 'geo:polygon:parallelogram:)) #:stroke stroke #:fill pattern #:window +nan.0+nan.0i
...
(define geo-rhombus
  (lambda [#:id [id : (Option Symbol) #false]
    ...
    (geo-polygon #:id (or id (gensym 'geo:polygon:rhombus:)) #:stroke stroke #:fill pattern #:window +nan.0+nan.0i
...
(define geo-trapezium : (->* (Real-Length Length+%)
                             ...
                             Geo:Polygon)
  (lambda [width height [t 0.618] #:id [id #false] #:stroke [stroke (void)] #:fill [pattern (void)]]
    (define-values (flwidth flheight) (~extent width height))
    
    (geo-polygon #:id (or id (gensym 'geo:polygon:trapezium:)) #:stroke stroke #:fill pattern #:window +nan.0+nan.0i
