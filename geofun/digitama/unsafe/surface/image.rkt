...
(unsafe-require/typed/provide
 (submod "." unsafe)
 [cairo-create-image-surface (-> Nonnegative-Flonum Nonnegative-Flonum Positive-Flonum (Values Bitmap-Surface Positive-Index Positive-Index))]
 [cairo-create-argb-image-surface* (-> Nonnegative-Flonum Nonnegative-Flonum Positive-Flonum Boolean
