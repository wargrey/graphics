...
(module+ main
  ...
  (geo-vc-append
   (geo-path #:source-tip the-pixel.mrk #:target-tip the-pixel.mrk
   ...
   (geo-path-group (geo-path (list F1 (+ F1 F2) F2) #:stroke aux-pen)
                   (geo-path #:source-tip the-bullet.mrk #:target-tip the-arrow.mrk #:target-placement 'inside
                   ...
                   (geo-path #:source-tip the-bullet.mrk #:target-tip the-arrow.mrk #:target-placement 'inside #:tick-placement 'negative
