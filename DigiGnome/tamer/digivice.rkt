...
@chunk[|<make the demo from scratch>|
       ...
       (define-tamer-suite make-demo "Instantiate Demo Sources"
         #:before setup-demo
...
@chunk[|<testcase: make digivice>|
       (let ([msecs file-or-directory-modify-seconds])
         ...
         (test-spec "exec racket <digivice>"
                    ...
                    #:after refresh-$
                    (check-pred zero? ($?) "demo exit abnormally")))]
...
Until now we are done with playing the toy demo, and it is time to hunt for some real world problems.
...
@chunk[|<destroy the demo zone>|
       ...
       (define-tamer-suite clean-demo "Remove Demo Sources"
