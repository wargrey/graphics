...
@(itemlist #:style 'compact
           @item{[@bold{prerequisites.sh}](prerequisites.sh): Build the latest Racket and Swi-Prolog from offical source.}
           @item{[@bold{makefile.rkt}](makefile.rkt): As its name shows, it is the alternative to Makefile.})

@section{Subprojects}
@(itemlist #:style 'compact
           @item{[@bold{Sakuyamon}](https://github.com/digital-world/sakuyamon) is in charge of gyoudmon.org}
