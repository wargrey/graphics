...
@section{Hierarchy}
@margin-note{Project or Subprojects are organized as the @italic{digimons}, and each of them may be separated into several repositories.}
...
@(itemlist @item{@bold{digitama} is the egg of @italic{digimons}. Namely it works like @tt{src} @bold{and} @tt{libraries}/@tt{frameworks}.}
           ...
           @nested{@bold{tamer} is the interface for developers to train the @italic{digimons}. Namely it works like @tt{test}.
                    @(itemlist @item{@italic{@bold{behavior}} shares the same name and concepts as in
