...
(define dia-preset-zone-stroke : Pen (desc-stroke #:width 1.5 #:color 'Grey #:join 'round #:cap 'round))
...
(define dia-preset-tag-font-tweak : Font:Tweak (make-font:tweak #:weight 'bold))
