...
(define default-dia-path-edge-construct : Dia-Path-Arrow->Edge
  (lambda [source target style tracks labels]
    (geo-path-attach-label
     (geo-path* #:id (dia-edge-id-merge (geo-id source) (and target (geo-id target)) #true)
...
(define default-dia-path-edge-label-construct : Dia-Path-Arrow->Edge-Label
  (lambda [source target style idx label base-position]
    (make-geo-path-labels #:font (dia-edge-select-font style)
...
(define default-dia-path-free-edge-construct : Dia-Path-Free-Track->Edge
  (lambda [source target style tracks labels]
    (geo-path-attach-label
     (geo-path* #:id (dia-edge-id-merge source target #false)
                #:stroke (dia-edge-select-line-paint style)
                #:source-tip (dia-edge-select-source-tip style)
