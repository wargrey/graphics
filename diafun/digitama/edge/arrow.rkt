...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(define dia-arrow-tip-vertices : (-> Dia-Arrow-Tip Nonnegative-Flonum Flonum (-> Float-Complex Float-Complex)
                                     (Values Geo-Path-Clean-Prints Flonum Flonum Nonnegative-Flonum Nonnegative-Flonum (Option Float-Complex) Boolean))
  (lambda [self 100% angle.rad op]
    ...
    (define-values (prints _x _y _w _h)
      (if (dia-arrow-tip-curved? self)
          (geo-curved-dart-metrics r angle.rad (and wing (~radian wing)) (op offset))
          (geo-dart-metrics r angle.rad (and wing (~radian wing)) (op offset))))
