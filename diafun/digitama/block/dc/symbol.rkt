...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(define #:forall (S) dia-symbol-circle : (->* (Symbol (Dia-Block-Style-Spec S)
                                                      Nonnegative-Flonum Nonnegative-Flonum (Option Flonum)
                                                      (Listof Real) Symbol)
                                              (Any)
                                              Dia:Block)
  (lambda [key style width height direction diameters type [etags #false]]
...
(define #:forall (S) dia-symbol-diamond : (->* (Symbol (Dia-Block-Style-Spec S)
                                                       Nonnegative-Flonum Nonnegative-Flonum (Option Flonum)
                                                       Symbol)
                                               (Any)
                                               Dia:Block)
  (lambda [key style width height direction type [etags #false]]
...
(define #:forall (S) dia-symbol-bullseye : (->* (Symbol (Dia-Block-Style-Spec S)
                                                        Nonnegative-Flonum Nonnegative-Flonum (Option Flonum)
                                                        Length+% Symbol)
                                                (Any)
                                                Dia:Block)
  (lambda [key style width height direction r% type [etags #false]]
    (define R : Nonnegative-Flonum (* (min width height) 0.5))
...
(define #:forall (S) dia-symbol-regular-triangle : (->* (Symbol (Dia-Block-Style-Spec S) Nonnegative-Flonum (Option Flonum) Symbol Symbol)
                                                        (Any)
                                                        Dia:Block)
  (lambda [key style height direction apex-position type [etags #false]]
