...
(define bitmap-stadium
  (lambda [#:stroke [outline : Maybe-Stroke-Paint (default-stroke-paint)] #:fill [pattern : Option-Fill-Paint (default-fill-paint)]
    ...
    (draw-bitmap dc_stadium #:with [w h density #true filter (stroke-paint->source* outline)]
...
(define bitmap-lstadium
  (lambda [#:stroke [outline : Maybe-Stroke-Paint (default-stroke-paint)] #:fill [pattern : Option-Fill-Paint (default-fill-paint)]
    ...
    (draw-bitmap dc_half_stadium #:with [w h density #true filter (stroke-paint->source* outline)]
...
(define bitmap-bullet
  (lambda [#:stroke [outline : Maybe-Stroke-Paint (default-stroke-paint)] #:fill [pattern : Option-Fill-Paint (default-fill-paint)]
    ...
    (draw-bitmap dc_bullet #:with [w h density #true filter (stroke-paint->source* outline)]
...
(define bitmap-sandglass
  (lambda [#:neck-width [neck-width : Real -0.1618] #:neck-height [neck-height : Real -0.0618] #:tube-height [tube-height : Real 0.0]
    ...
    (draw-bitmap dc_sandglass #:with [w h density #true filter (stroke-paint->source* outline)]
...
(define bitmap-document
  (lambda [#:stroke [outline : Maybe-Stroke-Paint (default-stroke-paint)] #:fill [pattern : Option-Fill-Paint (default-fill-paint)]
    ...
    (draw-bitmap dc_document #:with [w h density #true filter (stroke-paint->source* outline)]
...
(define bitmap-database
  (lambda [#:extra-n [extra-n : Index 0] #:gapsize [gapsize : Real -0.618]
    ...
    (draw-bitmap dc_database #:with [w h density #true filter (stroke-paint->source* outline)]
