...
(define bitmap-icosahedron-side-projection
  (lambda [#:edge [edge : Maybe-Stroke-Paint (default-stroke-paint)] #:border [border : Option-Stroke-Paint #false]
    ...
    (draw-bitmap dc_icosahedron_side_proj #:with [fllength fllength density #true filter (or bs es)]
                 [es (fill-paint->source* pattern)] [])))

(define bitmap-icosahedron-over-projection
  (lambda [#:edge [edge : Maybe-Stroke-Paint (default-stroke-paint)] #:border [border : Option-Stroke-Paint #false]
           #:fill [pattern : Option-Fill-Paint #false] #:rotation [rotation : Real 0.0] #:radian? [radian? : Boolean #true]
           #:filter [filter : Symbol (default-pattern-filter)] #:density [density : Positive-Flonum (default-bitmap-density)]
           [radius : Real] [radius-type : 3D-Radius-Type 'vertex]] : Bitmap
    ...
    (draw-bitmap dc_icosahedron_over_proj #:with [fllength fllength density #true filter (or bs es)]
