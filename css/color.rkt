...
(provide (all-defined-out) <css-color> select-color RGBA-Color)
...
(define current-css-element-color : (Parameterof Color+sRGB RGBA-Color) (make-parameter (select-color #x000000) select-color))
...
(define css->color : (CSS->Racket (U RGBA-Color CSS-Wide-Keyword 'currentcolor))
...
(define css-color-ref : (case-> [CSS-Values (Option CSS-Values) -> RGBA-Color]
                                [CSS-Values (Option CSS-Values) Symbol -> (CSS-Maybe RGBA-Color)])
  ;;; NOTE
  ...
  (case-lambda
    [(declared-values inherited-values)
     (define color : (CSS-Maybe (U 'currentcolor RGBA-Color)) (css-ref declared-values inherited-values 'color css->color))
     (if (css-wide-keyword? color) (current-css-element-color) (select-color color))]
    [(declared-values inherited-values property)
     (define xxx-color : (CSS-Maybe (U 'currentcolor RGBA-Color)) (css-ref declared-values inherited-values property css->color))
