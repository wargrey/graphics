...
(define css-border-style-option : (Listof Symbol)
  '(solid transparent dot    long-dash
          ...
          short-dash xor hilite dot-dash double #|no counterparts|#
...
(define <:border-width:> : (Pairof CSS-Shorthand-Parser (Listof Symbol))
...
(define <:border-top:> : (Pairof CSS-Shorthand-Parser (Listof Symbol))
...
(define <:border-right:> : (Pairof CSS-Shorthand-Parser (Listof Symbol))
  (css-make-pair-parser (list (<css-color>)       (<border-width>)    (<css-keyword> css-border-style-option))
                        (list 'border-right-color 'border-right-width 'border-right-style)))

(define <:border-bottom:> : (Pairof CSS-Shorthand-Parser (Listof Symbol))
  (css-make-pair-parser (list (<css-color>)        (<border-width>)     (<css-keyword> css-border-style-option))
                        (list 'border-bottom-color 'border-bottom-width 'border-bottom-style)))

(define <:border-left:> : (Pairof CSS-Shorthand-Parser (Listof Symbol))
  (css-make-pair-parser (list (<css-color>)      (<border-width>)   (<css-keyword> css-border-style-option))
